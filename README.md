...
```
                    ...
                    ┌───────────────┴───────────────┐
                    ▼                                 ▼
        Confidence State + Audit Trail        ML Re-ranker
...
<p align="center">
  <img src="docs/images/current-lead.png" width="100%">
</p>

## Deployment & Scalability

JohnWatson is fully containerized using Docker and deployed on Kubernetes with multiple replicas behind a Service. This validates that the complete replay pipeline—not just a single inference endpoint—can be executed concurrently across multiple application instances.

<p align="center">
  <img src="docs/images/k8s-load.png" width="100%">
</p>
...
<p align="center">
  <img src="docs/images/confusion_matrix.png" width="65%">
</p>
